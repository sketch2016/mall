...
import com.example.sketchxu.mall.adapter.WareOrderAdapter;
import com.example.sketchxu.mall.adapter.layoutmanager.FullyLinearLayoutManager;
import com.example.sketchxu.mall.bean.Charge;
import com.example.sketchxu.mall.bean.CreateOrderRespMsg;
...
import com.example.sketchxu.mall.utils.JsonUtil;
...
//                String extraMsg = data.getExtras().getString("extra_msg"); // 错误信息
    ...
    private void changeOrderStatus(final int status){
        ...
        okHttpHelper.post(Contants.API.ORDER_COMPLEPE, params, new SpotsCallback<BaseMessage>(this) {
    ...
    class WareItem {
        ...
        public WareItem(int ware_id, int amount) {
